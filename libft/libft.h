...
/*   Updated: 2021/10/18 12:17:52 by oipadeol         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Allocates (with malloc(3)) and returns a string representing the 
//hexadecimal number received as an argument. x = 0 and X = 1
char	*ft_uxtoa(unsigned int n, int x);
// Allocates (with malloc(3)) and returns a string representing the 
//hexadecimal unsigned long number received as an argument.
